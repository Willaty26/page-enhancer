...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Alex Rojas — Digitalizate ya!" },
      { property: "og:locale", content: "es_ES" },
      { name: "twitter:card", content: "summary" },
      { title: "Alex Rojas — Desarrollo Web Profesional" },
      { property: "og:title", content: "Alex Rojas — Desarrollo Web Profesional" },
      { name: "twitter:title", content: "Alex Rojas — Desarrollo Web Profesional" },
